...
using Skoruba.IdentityServer8.Admin.BusinessLogic.Services;
using Skoruba.IdentityServer8.Admin.BusinessLogic.Services.Interfaces;
using Skoruba.IdentityServer8.Admin.UI.Configuration;
using Skoruba.IdentityServer8.Admin.UI.Configuration.ApplicationParts;
using Skoruba.IdentityServer8.Admin.UI.Configuration.Constants;
...
using Skoruba.IdentityServer8.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer8.Admin.EntityFramework.Repositories.Interfaces;
using Skoruba.IdentityServer8.Admin.UI.ExceptionHandling;
using Skoruba.IdentityServer8.Admin.UI.Helpers.Localization;
using System;
...
using Skoruba.IdentityServer8.Admin.UI.Middlewares;
...
namespace Skoruba.IdentityServer8.Admin.UI.Helpers
{
