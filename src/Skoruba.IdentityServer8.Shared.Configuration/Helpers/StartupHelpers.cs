...
using SendGrid;
using Skoruba.IdentityServer8.Shared.Configuration.Configuration.Common;
using Skoruba.IdentityServer8.Shared.Configuration.Configuration.Email;
using Skoruba.IdentityServer8.Shared.Configuration.Email;

namespace Skoruba.IdentityServer8.Shared.Configuration.Helpers
{
    public static class StartupHelpers
    {
            ...
            where TDbContext : DbContext, IDataProtectionKeyContext
        {
            var dataProtectionBuilder = services.AddDataProtection()
                .SetApplicationName("Skoruba.IdentityServer8")
