...
using TechAdvisor.IdentityServer8.Admin.Api.AuditLogging;
using TechAdvisor.IdentityServer8.Admin.Api.Configuration;
using TechAdvisor.IdentityServer8.Admin.Api.Configuration.ApplicationParts;
using TechAdvisor.IdentityServer8.Admin.Api.Configuration.Constants;
using TechAdvisor.IdentityServer8.Admin.Api.Helpers.Localization;
...
namespace TechAdvisor.IdentityServer8.Admin.Api.Helpers
{
