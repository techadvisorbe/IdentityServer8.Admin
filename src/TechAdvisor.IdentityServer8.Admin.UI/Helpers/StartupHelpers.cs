...
using TechAdvisor.IdentityServer8.Admin.BusinessLogic.Services;
...
using TechAdvisor.IdentityServer8.Admin.UI.Configuration.ApplicationParts;
using TechAdvisor.IdentityServer8.Admin.UI.Configuration.Constants;
using TechAdvisor.IdentityServer8.Admin.EntityFramework.Helpers;
using TechAdvisor.IdentityServer8.Admin.EntityFramework.Interfaces;
using TechAdvisor.IdentityServer8.Admin.EntityFramework.Repositories;
using TechAdvisor.IdentityServer8.Admin.EntityFramework.Repositories.Interfaces;
using TechAdvisor.IdentityServer8.Admin.UI.ExceptionHandling;
using TechAdvisor.IdentityServer8.Admin.UI.Helpers.Localization;
using System;
...
using TechAdvisor.IdentityServer8.Admin.EntityFramework.Configuration.MySql;
using TechAdvisor.IdentityServer8.Admin.EntityFramework.Configuration.PostgreSQL;
using TechAdvisor.IdentityServer8.Admin.EntityFramework.Configuration.SqlServer;
using TechAdvisor.IdentityServer8.Shared.Configuration.Authentication;

namespace TechAdvisor.IdentityServer8.Admin.UI.Helpers
{
