...
using SendGrid;
using TechAdvisor.IdentityServer8.Shared.Configuration.Configuration.Common;
using TechAdvisor.IdentityServer8.Shared.Configuration.Configuration.Email;
using TechAdvisor.IdentityServer8.Shared.Configuration.Email;

namespace TechAdvisor.IdentityServer8.Shared.Configuration.Helpers
{
    public static class StartupHelpers
    {
            ...
            where TDbContext : DbContext, IDataProtectionKeyContext
        {
            var dataProtectionBuilder = services.AddDataProtection()
                .SetApplicationName("TechAdvisor.IdentityServer8")
