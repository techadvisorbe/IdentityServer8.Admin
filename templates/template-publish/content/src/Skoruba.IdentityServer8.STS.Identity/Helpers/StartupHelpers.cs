...
using Skoruba.IdentityServer8.STS.Identity.Configuration;
using Skoruba.IdentityServer8.STS.Identity.Configuration.ApplicationParts;
using Skoruba.IdentityServer8.STS.Identity.Configuration.Constants;
using Skoruba.IdentityServer8.STS.Identity.Configuration.Interfaces;
using Skoruba.IdentityServer8.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace Skoruba.IdentityServer8.STS.Identity.Helpers
{
