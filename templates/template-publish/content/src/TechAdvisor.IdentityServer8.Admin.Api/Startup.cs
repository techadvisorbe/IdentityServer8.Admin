...
using TechAdvisor.IdentityServer8.Admin.Api.Configuration.Authorization;
using TechAdvisor.IdentityServer8.Admin.Api.ExceptionHandling;
using TechAdvisor.IdentityServer8.Admin.Api.Helpers;
using TechAdvisor.IdentityServer8.Admin.Api.Mappers;
using TechAdvisor.IdentityServer8.Admin.Api.Resources;
...
using TechAdvisor.IdentityServer8.Shared.Configuration.Helpers;
using TechAdvisor.IdentityServer8.Shared.Dtos;
using TechAdvisor.IdentityServer8.Shared.Dtos.Identity;

namespace TechAdvisor.IdentityServer8.Admin.Api
{
