...
using TechAdvisor.IdentityServer8.STS.Identity.Configuration;
using TechAdvisor.IdentityServer8.STS.Identity.Configuration.ApplicationParts;
using TechAdvisor.IdentityServer8.STS.Identity.Configuration.Constants;
using TechAdvisor.IdentityServer8.STS.Identity.Configuration.Interfaces;
using TechAdvisor.IdentityServer8.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace TechAdvisor.IdentityServer8.STS.Identity.Helpers
{
